...
Les sessions que squad ouvre pour un seul travail, la **vérification préalable** d'une fiche de
...
Constaté le 09/09/2026 sur l'instance réelle : dix fiches attendaient. Les vérifier
...
construit et une session qui vérifie, elles coûtent le même processus et la même suite
de tests.
...
| 2 | vérification préalable | le travail est fait, une personne attend derrière |
...
faux : un ticket que squad vérifie **n'attend personne**, et le lister comme attendant
...
Au redémarrage, une vérification interrompue repart, bornée par les deux tours qui
...
La vérification demandée à la main répond toujours en face quand une place est libre,
